  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      contents: [
        ...
        각 지표의 의미:
        - Recommend.All: 모든 추천 종합 신호
        - Recommend.MA: 이동평균 추천 신호
        - Recommend.Other: 기타 기술적 추천 신호
        - RSI: 상대강도지수 (0-100, 70이상 과매수, 30이하 과매도)
        - Mom: 모멘텀 지표
        - AO: Awesome Oscillator (놀라운 오실레이터)
        - CCI20: Commodity Channel Index 20일
        - Stoch.K: 스토캐스틱 K값
        - Stoch.D: 스토캐스틱 D값
        - pricescale, minmov, fractional, minmove2: 가격 관련 메타데이터
