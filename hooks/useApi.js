...
const useApi = () => {
  ...
  const api = {
    ...
    trading: {
      order: () => {}, // 해외주식 주문
      orderRvsecncl: () => {}, // 해외주식 정정취소주문
      orderResv: () => {}, // 해외주식 예약주문접수
      orderResvCcnl: () => {}, // 해외주식 예약주문접수취소
      ...
      inquireCcnl: () => {}, // 해외주식 주문체결내역
      inquirePresentBalance: () => {}, // 해외주식 체결기준현재잔고
      //inquireResv: () => {}, // 해외주식 예약주문조회
      inquireBuyableAmount: () => {}, // 해외주식 매수가능금액조회
    },
  };
